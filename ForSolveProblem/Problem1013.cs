...
{
    public class Problem1013 : IProblem
    {
        public void RunProblem()
        {
            var temp = CanThreePartsEqualSum(new int[] { 29, 31, 27, -10, -67, 22, 15, -1, -16, -29, 59, -18, 48 });
        }
        ...
        public bool CanThreePartsEqualSum(int[] A)
        {
            ...
            queueTemp.Enqueue(oneValue * 2);
            queueTemp.Enqueue(oneValue * 3);
